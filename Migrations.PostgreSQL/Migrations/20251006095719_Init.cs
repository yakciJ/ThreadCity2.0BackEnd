        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarImgId = table.Column<int>(type: "integer", nullable: true),
                    AvatarImageImageId = table.Column<int>(type: "integer", nullable: true),
                    CoverImgId = table.Column<int>(type: "integer", nullable: true),
                    CoverImageImageId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Images_AvatarImageImageId",
                        column: x => x.AvatarImageImageId,
                        principalTable: "Images",
                        principalColumn: "ImageId");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Images_CoverImageImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkPostTags", x => x.LinkId);
                    table.ForeignKey(
                        name: "FK_LinkPostTags_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LinkPostTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostImages", x => x.PostImgId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostScoreId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PostId = table.Column<int>(type: "integer", nullable: false),
                    TimeScore = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeenId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "text", nullable: true),
                    PostId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeenPosts", x => x.SeenId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPostScores", x => new { x.UserId, x.PostId });
                    table.ForeignKey(
                        name: "FK_UserPostScores_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPostScores_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ea3ea71a-c34a-4bf7-a265-8bcd8a74b39f", null, "User", "USER" },
                    { "ea5a8f2b-48ee-4e75-a78d-a2feb2a5130e", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AvatarImageImageId",
                table: "AspNetUsers",
                column: "AvatarImageImageId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CoverImageImageId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LinkPostTags_PostId",
                table: "LinkPostTags",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_LinkPostTags_TagId",
                table: "LinkPostTags",
                column: "TagId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPostScores_PostId",
                table: "UserPostScores",
                column: "PostId");
        }
